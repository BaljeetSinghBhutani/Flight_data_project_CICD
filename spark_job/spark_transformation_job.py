...
def main(env, bq_project, bq_dataset, transformed_table, route_insights_table, origin_insights_table):
    try:
        ...
        input_path = f"gs://airflow-projects-gsd/airflow-project-1/source-{env}"
        ...
        transformed_data = data.withColumn(
            ...
            "lead_time_category", when(col("purchase_lead")< 7, lit("Last_Minute"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--transformed_table", required=True, help="BigQuery table for tranformed data")
